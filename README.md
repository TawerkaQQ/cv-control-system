## Всем привет, это наш совместный проект по детекции и идентификации людей с помощью камер видеонаблюдения, с фиксацией времени входа/выхода человека из здания
